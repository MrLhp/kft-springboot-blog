...
public class EqualAmountOfPrincipal {
     ...
     */
    public List<EqualAmountBean> execEqualAmountPrincipal(double quota,double interestRate,double interestRebate,Date dateOfLoan,int stageNumberOfMonth) {
    ...
    @Test
    public void test() {
        List<EqualAmountBean> equalAmountBeans = this.execEqualAmountPrincipal(50000, 0.0075, 0, new Date(), 12);
